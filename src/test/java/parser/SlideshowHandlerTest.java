...
class SlideshowHandlerTest {
    ...
    void testValidFile() throws Exception {
        ...
        ImageDataStorage image1 = new ImageDataStorage(10, 10,
                new URL("file://resources/images/image.png"),
                5,
                6,
                0);
        ...
        VideoDataStorage video1 = new VideoDataStorage(20, 9,
                new URL("file://resources/videos/video.mp4"), "testVideo", true);
        AudioDataStorage audio1 = new AudioDataStorage(new URL("file://resources/audio/audio.wav"), 10, true);
